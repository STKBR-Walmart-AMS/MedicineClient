...
public class MedicineUtil {
    ...
    public List<Incident> sendData(String user, String pass, JTextArea msg, StringBuilder history) {
        ...
        incidentList = queryEntrysByQual(queryList, this.msg, this.history);
    ...
    private ARServerUser login(String user, String pass, JTextArea msg, StringBuilder history) {
        ...
        history.append(user);
        history.append(" autenticando\n");
        msg.setText(history.toString());

        try {
            ctx.verifyUser();
            history.append("*******************************\n");
            history.append("Usuário autenticado com sucesso\n");
            history.append("*******************************\n");
            msg.setText(history.toString());
        } catch (ARException e) {
            history.append("*******************************\n");
            history.append("Houve uma falha na autenticação\n");
            history.append("*******************************\n");
        ...
        history.append("Connected to AR Server ");
        history.append(ctx.getServer());
        history.append("\n");
        msg.setText(history.toString());
        return ctx;
    }
    ...
    public List<Incident> queryEntrysByQual(String qualStr, JTextArea msg, StringBuilder history) {
        List<Entry> entryList = new ArrayList<Entry>();
        ...
        history.append("Retrieving entryies with qualification ");
        history.append(qualStr);
        history.append("\n");
        msg.setText(history.toString());
        ...
        try {
            ...
            history.append("Query returned ");
            history.append(nMatches);
...
//            System.out.println("Query returned " + nMatches + " matches.");
    ...
    private void postRemedys(List<Incident> lstIncident) {
        ...
        try {
            ...
            history.append("*******************************\n");
            history.append("Estamos no POST\n");
            history.append("*******************************\n");
            msg.setText(history.toString());
            ...
            if (response.getStatusLine().getStatusCode() != 201) {
                ...
                history.append("*******************************\n");
                history.append("Ocorreu uma falha no POST\n");
                history.append("*******************************\n");
                history.append("Failed : HTTP error code : ");
    ...
    private boolean statusServer() {
        try {
            ...
            DefaultHttpClient httpClient = new DefaultHttpClient();
            HttpGet getRequest = new HttpGet("http://medicineweb-stkbr.rhcloud.com/rest/incident");
            ...
            while ((output = br.readLine()) != null) {
                history.append("Output from Server .... \n");
            ...
            history.append("Falha Protocoloe .... \n");
            history.append(e.getMessage());
            msg.setText(history.toString());
            //e.printStackTrace();
